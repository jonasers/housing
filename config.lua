...
Strings = {
    ...
    ['Manage_House'] = 'administrere dit hus',
    ['Buy_House'] = 'købe hus #%s',
    ['Knock_House'] = 'Bank på døren',
    ['Your_House'] = 'Dit hus',
    ['Buyable_House'] = 'Købeligt hus',
    ['Player_House'] = 'Spillerens hus',
    ['Storage'] = 'få adgang til dit lager',
    ['Sell_House'] = 'Sælg for $%s',
    ['Enter_House'] = 'Gå ind i huset',
    ['Sell_Confirm'] = 'Sælg hus for $%s?',
    ['yes'] = 'ja',
    ['no'] = 'nej',
    ['Sold_House'] = 'Du solgte dit hus for $%s',
    ['Must_Sell'] = 'Du kan kun eje ét hus Sælg dit hus for at købe denne.',
    ['Buy_House_Confirm'] = 'Køb hus #%s for $%s?',
    ['Manage_Door'] = 'anage dør',
    ['Accept'] = 'Accepter nogen til at komme ind',
    ['Exit'] = 'Forlad huset',
    ['Noone_Home'] = 'Ingen ser ud til at være hjemme!',
    ['Someone_Knocked'] = 'Nogen bankede på. Gå til døren for at lukke dem ind!',
    ['Let_In'] = 'Lad nogen komme ind',
    ['Accept_Player'] = 'Lad %s komme ind?',
    ['Waiting_Owner'] = 'Waiting husejeren til at lukke dig ind.',
    ['ikea'] = 'IKEA',
    ['Buy_Furniture'] = 'ind i butikken',
    ...
    ['Confirm_Purchase'] = 'Køb %s for $%s?',
    ['no_money'] = "Du har ikke penge nok.",
    ['Bought_Furniture'] = 'Købte 1x %s for $%s',
    ['Furnish'] = 'Indret dit hus',
    ['Store_Garage'] = 'Tryk på ~INPUT_CONTEXT~ for at gemme køretøjet', 
    ['Re_Furnish'] = 'Fjern placerede møbler',
    ['Remove'] = 'Fjern %s (#%s)',
    ['Amount'] = 'Hvor mange?',
    ['Player_Inventory'] = 'Dit inventar',
    ['House_Inventory'] = 'inventar',
    ['Invalid_Amount'] = 'Ugyldigt beløb. Indtast venligst et nummer.',
    ['Store'] = 'butik',
    ['Withdraw'] = 'Træk tilbage',
    ['Storage_Title'] = 'Opbevaring',
    ['You_Stored'] = 'Du har gemt %sx %s',
    ['You_Withdrew'] = 'Du trak %sx %s tilbage',
    ['Not_Enough'] = 'Du har ikke så mange!',
    ['Not_Enough_House'] = 'Der er ikke så mange på lageret!',
    ['Weapons'] = 'Våben',
    ['Items'] = 'Items',
    ['No_Weapon'] = 'Du har ikke det våben på dig!',
    ['bullets'] = 'kugler', 
    ['Rotation'] = 'rotation',
    ['Guests'] = 'Dine gæster skal forlade huset, før du kan gøre dette.',
    ['Garage'] = 'Gå ind i garagen',
    ['No_Spawn'] = 'Kunne ikke finde et spawnpoint til dit hus.',
    ['Host_Left'] = 'Husejeren forlod serveren, du blev smidt ud af deres hus.',
    ['No_Money'] = 'Du har ikke penge nok!',
